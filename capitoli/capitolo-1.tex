...
\begin{itemize}
	...
	\item \textbf{\gls{Bash}}: per effettuare l'analisi dei dati preliminare da parte del team \textins{big data} viene utilizzata la \textit{shell} di Linux per eseguire i tool interessati (ad esempio Hive, Impala, Spark o per visualizzare il \textit{filesystem} HDFS).
\end{itemize}
